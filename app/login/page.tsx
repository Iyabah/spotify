      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card p-6 scale-in">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/70 text-base">Sign in to your account to continue</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button 
              type="submit" 
              className="btn-primary w-full text-base py-3 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={loading}
            >
              {loading ? (
            ...
            {error && (
              <div className="text-red-400 text-center text-sm bg-red-400/10 border border-red-400/20 rounded-xl p-3 fade-in-up">
